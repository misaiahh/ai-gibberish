...
src/
  ...
  components/
    TodoApp.js         # Root component — manages state, event routing
    TodoApp.test.js
    ...
    TodoList.test.js
  utils/
    todoUtils.js       # Todo helpers (generateId, addTodo, toggleTodo, etc.)
    todoUtils.test.js
```
...
|-----------|-------------|
| `todo-app` | Root component. Holds the todos array, filter state, and routes events. |
